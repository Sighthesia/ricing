...
| Skill                                                        | When to use                                                                        |
| ------------------------------------------------------------ | ---------------------------------------------------------------------------------- |
| [qml-architecture](.agents/skills/qml-architecture/SKILL.md) | QML architecture rules, file structure, naming conventions, and imports.           |
| [qml-state](.agents/skills/qml-state/SKILL.md)               | Guidelines for managing settings, state, persistence, and error handling.          |
