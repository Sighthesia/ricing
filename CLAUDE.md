...
| [multi-instance-focus-ownership](.agents/skills/multi-instance-focus-ownership/SKILL.md) | When a text field or editable control works once but stops accepting keyboard input on reopen, page switch, or second mount because multiple live instances or wrapper/child focus hooks compete for ownership. |
