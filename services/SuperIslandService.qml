...
Singleton {
    ...
    function _normalizeEvent(event) {
        ...
        const normalized = {
            ...
            workspaceIndex: event.workspaceIndex !== undefined ? event.workspaceIndex : -1,
            activeWorkspacePosition: event.activeWorkspacePosition !== undefined ? event.activeWorkspacePosition : -1,
            currentWindowId: event.currentWindowId || "",
            currentIndex: event.currentIndex !== undefined ? event.currentIndex : -1,
