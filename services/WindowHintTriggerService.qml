...
Singleton {
    ...
    readonly property string _helperOverride: (Quickshell.env("DYMICSHELL_WINDOW_HINT_TRIGGER_CMD") || "").trim()
    ...
    function _handleLine(line) {
        ...
        case "toggle":
            ...
            return
        default:
            console.warn("[DymicShell:WindowHintTriggerService] Ignoring unknown trigger event", normalized)
            return
        }
    }
