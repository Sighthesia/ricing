...
function slotGeometryRecord(sectionName, widget, slotIndex, left, width, sectionGeometry) {
    ...
    return {
        ...
        layoutReservationWidth: nextWidth,
        layoutRevealWidth: nextWidth,
        reservationWidth: nextWidth,
...
function widgetGeometryFromSlot(sectionName, slot) {
    ...
    return {
        ...
        layoutReservationWidth: width,
        layoutRevealWidth: width,
...
function clampedSectionGeometry(sectionName, left, right, contentWidth, slotCount, contract) {
    ...
    return {
        ...
        layoutReservationWidth: layoutWidth,
        layoutRevealWidth: visualWidth,
        reservationWidth: layoutWidth,
        revealWidth: visualWidth,
        left: visualLeft,
        right: visualRight,
        width: visualWidth,
