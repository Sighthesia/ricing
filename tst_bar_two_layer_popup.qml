...
Item {
    ...
    function checkTopDirection() {
        ...
        // The host pins contentDelay 0: reveal is purely geometric, both
        // layers slide together from frame one (no opacity staging).
        root.check("top: content delay is zero (geometric reveal)", host.popupItem.contentDelay, 0)
