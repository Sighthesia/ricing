...
Item {
    ...
    TestCase {
        ...
        function test_sidebarActionsUseCompactFullWidthGeometry() {
            ...
            compare(sidebar.collapseSurfaceItem.width, sidebar.width)
            compare(sidebar.backSurfaceItem.width, sidebar.width - 4)
        ...
        function test_openSessionWaveRevealCompletes() {
            panel.beginSession()
            tryCompare(panel.appearancePage.wallpaperRow, "opacity", 1, 1500)
            tryVerify(function() {
        ...
        function test_openSessionReducedMotionSkipsWave() {
            ...
            compare(panel.appearancePage.wallpaperRow.opacity, 1)
        ...
        function test_rapidReopenConvergesToFullGeometry() {
            ...
            tryCompare(panel.appearancePage.wallpaperRow, "opacity", 1, 2000)
