...
Item {
    TestCase {
        ...
        function test_themeTokens() {
            ...
            compare(Lazer.LazerTheme.settingsRangePadding, 8)
            compare(Lazer.LazerTheme.settingsSliderThumb, "#ebe5ff")
            verify(Lazer.LazerTheme.settingsSliderThumb !== Lazer.LazerTheme.settingsAccent)
