...
// Hosts attached overlay content with reveal clipping while staying layout-detached.
Item {
    id: root
    ...
    y: root.detachedY - root.attachmentOverlap + (root.expanded ? 0 : -root.revealLift) - root.revealYOffset
