...
FocusScope {
    ...
    // Stack below a slider-style small label: full-width editor, left aligned.
    readonly property bool smallRowLabel: true
    ...
    // Provide the outlined field surface and focus ring. The ring tracks
