    ...
    Grid {
        ...
        Repeater {
            ...
            Item {
                ...
                // True while the shell palette for this template is being
                // regenerated by the extraction script (cache miss path).
                readonly property bool busy:
                    Services.ColorService.isExtracting
                    && Services.ColorService.pendingScheme === modelData
                ...
                // Busy marker while the script regenerates this template's
                // palette: a spinning accent diamond over the dimmed swatches.
                Rectangle {
                    visible: card.busy
                    anchors.centerIn: swatchStrip
                    width: 12
                    height: 12
                    rotation: 45
                    ...
                    RotationAnimation on rotation {
                        running: card.busy && !MotionTokens.reducedMotion
                        loops: Animation.Infinite
                        from: 45
                        to: 405
                        duration: MotionTokens.slow * 4
                    }
                }
