...
Flickable {
    ...
    Column {
        ...
        LazerSettingsRow { width: pageColumn.width - 16; x: 8; labelText: "通知位置"; LazerSettingsChoice { id: positionChoiceControl; model: [{ value: "top-left", label: "左上" }, { value: "top-right", label: "右上" }, { value: "bottom-left", label: "左下" }, { value: "bottom-right", label: "右下" }]; currentValue: root.settingsObject ? root.settingsObject.position : "top-right"; onValueSelected: function(value) { if (root.settingsObject && ["top-left", "top-right", "bottom-left", "bottom-right"].indexOf(value) >= 0) { root.settingsObject.position = value; root.save() } } } }
    }
}
